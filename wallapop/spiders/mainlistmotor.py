...
'Cadiz', 'Cantabria', 'Castello-Castellon', 'Cordoba', 'Cuenca', 'Girona', 'Granada', 'Guadalajara', 'Guipuzcoa', 'Huelva', 'Huesca', 'Islas-Baleares', 'Jaen', 'La-Rioja', 'Las-Palmas', 'Leon', 'Lleida', 'Lugo', 'Madrid', 'Malaga', 'Murcia', 'Navarra', 'Ourense', 'Palencia', 'Pontevedra', 'Salamanca', 'Santa-Cruz-de-Tenerife', 'Segovia', 'Sevilla', 'Soria', 'Tarragona', 'Teruel', 'Toledo', 'Valencia', 'Valladolid', 'Vizcaya', 'Zamora', 'Zaragoza']
        for province in list_spain_province:
	       ...
	       #base_url = 'https://es.wallapop.com/rest/seoitems?path=%2Flist%2Fprovincia-'+province+'%2Fcoches&total=29800555&lastItemId=167641754&_p=0'  #total and id from a-corona
	       base_url = 'https://es.wallapop.com/rest/seoitems?path=%2Flist%2Fprovincia-'+province+'%2Fmotor-y-accesorios&total=60891374&lastItemId=168424596&_p='
        
	       #base_url = 'https://es.wallapop.com/rest/seoitems?path=%2Flist%2Fmotor-y-accesorios&total=2926292&lastItemId=168447101&_p='#1	
